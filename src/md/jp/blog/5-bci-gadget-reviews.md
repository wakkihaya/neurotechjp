...
**今までEEGデータを触ったことがなく、はじめて脳波分析を試してみたい入門者や初学者は比較的低コストで始められるMuse、NeuroSky。**

**既にEEGデータに触れた経験があり、豊富でバラエティのあるデータを元に計測や分析・開発をしたい場合はEmotiv, OpenBCI。**

**脳波分析限らずモバイルやWebと連携したBCIアプリケーションをフルスタックで開発したい場合はNeurosity。**

&nbsp;

## さいごに

今回は 5 つの非侵襲型 BCI を長所・短所と共に取り上げた。研究向けと比較して手頃な価格で充実した SDK があるため、脳波分析をちょっとしてみたい方には是非試してもらいたい。

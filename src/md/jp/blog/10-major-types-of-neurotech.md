...
ひとくちに Neurotech といっても、その具体的な技術は、偉大な先人たちによる様々な学問の歴史によって織り成された研究成果が、幾重にも連なって現代に生まれている。Neurotech に触れたばかりの頃は、脳とコンピュータをつなげる BCI ばかりに夢中になって SF の世界が実現する未来を想像したかもしれない。

しかしこのシリーズでは BCI のみならず、俯瞰的な視点で、大きく 10 種類の技術に分類される Neurotech の技術をそれぞれ具体例を挙げながら紹介していく。
...
認知機能の評価と向上は、**脳や認知機能の発達、社会的認知の向上、職業能力の向上を目的**とした活動である。

&nbsp;

この 30 年の間に、神経科学の驚くべき発見が私たちの認知機能の未来を切り開いた。認知機能は普通年齢とともに低下していくが、**新しい神経技術によって脳の健康とパフォーマンスを向上させることができる**のだ。

瞑想、ビデオゲーム、スマートドラッグ、栄養補助食品、栄養、脳への刺激、運動、音楽、認知トレーニングなどの様々な活動により認知機能が評価・強化できることが、研究によってわかった。
...
神経薬理学は、**病気の人を治す治療と、気分をより良くする改善の両方に関わる学問**だ。それゆえ、病気の人を助けるために処方される薬から、最新の「スマート・ドラッグ」まで、すべての範囲が当てはまる。

&nbsp;

神経薬理学は大きく**分子神経薬理学**と**行動神経薬理学**に分けられる。
...
ニューロモデュレーションとは、"**刺激による神経活動の変化** "であり、電気刺激や化学物質などの刺激を体内の特定の神経部位に与えることで、神経活動を変化させる技術だ。

ニューロモデュレーションは多岐にわたる分野であり、様々な疾患の診断や治療、医療や神経科学の研究のためのツールなど、その用途は、神経刺激の種類によって異なる。また、薬剤を用いた薬理学的刺激も含まれる。

それら刺激の種類は、それぞれが異なる特性を持っている。
...
ニューロモニタリング／イメージングとは**脳や脊髄をスキャンする方法**だ。
...
1. **MRI スキャン**
   ...
   MRI スキャンは磁気共鳴画像法（Magnetic Resonance Imaging）の略で、磁場と電波を利用して脳と脳幹の詳細な画像を作成する検査だ。
...
2. **MEG (MagnetoEncephaloGraphy)**
   ...
   最大の利点は、MEG が EEG と同様の高い時間分解能を兼ね備えている一方で、高い空間分解能を持っていることである。
